...
<table style="font-family: Verdana,sans-serif; font-size: 11px; color: #374953; width: 550px">
	...
	<tr>
		<td align="left">Vaše objednávka byla úspěně vytvořena. Platba dobírkou.</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
...
<table style="font-family:Verdana,sans-serif;font-size:11px;color:#374953;width:550px">
	...
	<tr>
		...
		<table style="width:100%;font-size:11px;color:#374953">
			...
			<tr style="text-align:right">
				...
				Poštovný a balný</td>
				<td style="background-color:#dde2e6;padding:0.6em 0.4em">89 Kč</td>
			</tr>
	...
	<tr>
		<td align="left">Způsob dopravy: Česká pošta, dobírka</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
